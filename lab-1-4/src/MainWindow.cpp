...
Settings::Settings()
{
    ...
    setWindowIcon(QIcon("../assets/settings.png"));
}
...
{
    QPixmap settingsPic("../assets/settings.png");
    ...
    QPixmap exitPic("../assets/exit.png");
    ...
    QPixmap backgroundPic("../assets/background.jpg");
